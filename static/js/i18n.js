...
registerTranslations({
    en: {
        ...
        'auth.password_length_hint': 'At least 8 characters.',
        ...
        'auth.login_failed': 'Email or password is incorrect',
        'auth.twofa_code_label': 'Authentication Code',
        'auth.twofa_code_hint': 'Enter the 6-digit code from your authenticator app.',
        'auth.twofa_verify_btn': 'Verify',
        'auth.twofa_back': 'Back to login',
        'auth.twofa_invalid_code': 'Invalid code',
    ...
    tr: {
        ...
        'auth.email': 'E-posta',
        'auth.password': 'Şifre',
        'auth.password_length_hint': 'En az 8 karakter.',
        ...
        'auth.login_success': 'Giriş yapıldı',
        'auth.login_failed': 'E-posta veya şifre hatalı',
        'auth.twofa_code_label': 'Doğrulama Kodu',
        'auth.twofa_code_hint': 'Kimlik doğrulama uygulamanızdaki 6 haneli kodu girin.',
        'auth.twofa_verify_btn': 'Doğrula',
        'auth.twofa_back': 'Girişe geri dön',
        'auth.twofa_invalid_code': 'Geçersiz kod',
    ...
    fr: {
        ...
        'auth.password_length_hint': 'Au moins 8 caractères.',
        ...
        'auth.login_failed': 'E-mail ou mot de passe incorrect',
        'auth.twofa_code_label': "Code d'authentification",
        'auth.twofa_code_hint': "Entrez le code à 6 chiffres de votre application d'authentification.",
        'auth.twofa_verify_btn': 'Vérifier',
        'auth.twofa_back': 'Retour à la connexion',
        'auth.twofa_invalid_code': 'Code invalide',
        'sidebar.version': 'Version {version}',
        'sidebar.version_with_date': 'Version {version} · {date}',
    ...
    de: {
        ...
        'auth.password_length_hint': 'Mindestens 8 Zeichen.',
        ...
        'auth.login_failed': 'E-Mail oder Passwort ist falsch',
        'auth.twofa_code_label': 'Authentifizierungscode',
        'auth.twofa_code_hint': 'Geben Sie den 6-stelligen Code aus Ihrer Authenticator-App ein.',
        'auth.twofa_verify_btn': 'Bestätigen',
        'auth.twofa_back': 'Zurück zur Anmeldung',
        'auth.twofa_invalid_code': 'Ungültiger Code',
        'sidebar.version': 'Version {version}',
        'sidebar.version_with_date': 'Version {version} · {date}',
