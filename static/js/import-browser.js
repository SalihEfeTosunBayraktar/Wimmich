/**
 * Wimmich - Admin: filesystem browser and folder import flow.
 */
registerTranslations({
    en: {
        ...
        'import_browser.photos_label': 'Photos:',
        'import_browser.video_label': 'Video:',
        'import_browser.size_label': 'Size:',
        'import_browser.import_files_button': 'Import {count} Files',
    ...
    tr: {
        ...
        'import_browser.photos_label': 'Fotoğraf:',
        'import_browser.video_label': 'Video:',
        'import_browser.size_label': 'Boyut:',
        'import_browser.import_files_button': '{count} Dosyayı Aktar',
    ...
    fr: {
        ...
        'import_browser.photos_label': 'Photos :',
        'import_browser.video_label': 'Vidéo :',
        'import_browser.size_label': 'Taille :',
        'import_browser.import_files_button': 'Importer {count} fichiers',
    ...
    de: {
        ...
        'import_browser.photos_label': 'Fotos:',
        'import_browser.video_label': 'Video:',
        'import_browser.size_label': 'Größe:',
        'import_browser.import_files_button': '{count} Dateien importieren',
...
async function browsePath(path) {
    ...
    try {
        ...
        $('browse-path').value = data.current_path || '';
        ...
        if (!data.items.length) {
            html = `<div style="padding:24px;text-align:center;color:var(--text-muted)">${t('import_browser.no_media_found')}</div>`;
        }
