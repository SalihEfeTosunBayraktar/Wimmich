...
const API = {
    ...
    requestDataExport() { return this.request('/api/auth/export', { method: 'POST' }); },
    getExportStatus() { return this.request('/api/auth/export/status'); },
    getExportDownloadUrl() { return '/api/auth/export/download'; },
